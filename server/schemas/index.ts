...
import { productType, productArgs, createProductArgs, updateProductArgs, deleteProductArgs } from './products.schemas'
import { userType, userLoginType, signUpArgs, loginArgs } from './user.schemas'
import { productResolver, productsResolver, createProductResolver, updateProductResolver, deleteProductResolver } from '../resolvers/products.resolvers'
